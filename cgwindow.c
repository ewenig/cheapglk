...
void glk_window_get_arrangement( window_t *win, glui32 *methodptr, glui32 *sizeptr, winid_t *keywinptr )
{
    if ( !win || win != mainwin )
    {
...
void glk_window_set_arrangement( window_t *win, glui32 method, glui32 size, winid_t keywin )
{
    if ( !win || win != mainwin )
    {
