...
extern glui32 glk_gestalt_ext( glui32 sel, glui32 val, glui32 *arr, glui32 arrlen );
...
extern void glk_window_set_arrangement( winid_t win, glui32 method, glui32 size, winid_t keywin );
extern void glk_window_get_arrangement( winid_t win, glui32 *methodptr, glui32 *sizeptr, winid_t *keywinptr );
...
extern strid_t glk_stream_open_memory( char *buf, glui32 buflen, glui32 fmode, glui32 rock );
...
extern void glk_stylehint_set( glui32 wintype, glui32 styl, glui32 hint, glsi32 val );
...
extern glui32 glk_style_measure( winid_t win, glui32 styl, glui32 hint, glui32 *result );
...
extern frefid_t glk_fileref_create_from_fileref( glui32 usage, frefid_t fref, glui32 rock );
...
extern void glk_set_terminators_line_event( winid_t win, glui32 *keycodes, glui32 count );
#endif /* GLK_MODULE_LINE_TERMINATORS */

#ifdef GLK_MODULE_UNICODE

extern glui32 glk_buffer_to_lower_case_uni( glui32 *buf, glui32 len, glui32 numchars );
extern glui32 glk_buffer_to_upper_case_uni( glui32 *buf, glui32 len, glui32 numchars );
extern glui32 glk_buffer_to_title_case_uni( glui32 *buf, glui32 len, glui32 numchars, glui32 lowerrest );
...
extern strid_t glk_stream_open_file_uni( frefid_t fileref, glui32 fmode, glui32 rock );
extern strid_t glk_stream_open_memory_uni( glui32 *buf, glui32 buflen, glui32 fmode, glui32 rock );

extern void glk_request_char_event_uni( winid_t win );
extern void glk_request_line_event_uni( winid_t win, glui32 *buf, glui32 maxlen, glui32 initlen );

#endif /* GLK_MODULE_UNICODE */

#ifdef GLK_MODULE_UNICODE_NORM

extern glui32 glk_buffer_canon_decompose_uni( glui32 *buf, glui32 len, glui32 numchars );
...
extern void glk_window_erase_rect( winid_t win, glsi32 left, glsi32 top, glui32 width, glui32 height );
extern void glk_window_fill_rect( winid_t win, glui32 color, glsi32 left, glsi32 top, glui32 width, glui32 height );
...
extern glui32 glk_schannel_play_ext( schanid_t chan, glui32 snd, glui32 repeats, glui32 notify );
...
extern void glk_schannel_set_volume_ext( schanid_t chan, glui32 vol, glui32 duration, glui32 notify );
...
extern void glk_simple_time_to_date_utc( glsi32 time, glui32 factor, glkdate_t *date );
extern void glk_simple_time_to_date_local( glsi32 time, glui32 factor, glkdate_t *date );
